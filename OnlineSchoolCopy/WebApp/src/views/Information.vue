...
const accordionItems = ref<AccordionItem[]>([
  ...
  },
  {
    ...
    content: `
      ...
      <p>Руководитель — Нафин Ильмир Фанилевич <br>
      Телефон: +7 (927) 100-48-95 <br>
      Адрес электронной почты: rkshonline@mail.ru</p>
    `
  },
  {
            ...
            <div class="accordion-content" v-if="item.isOpen">
              <div class="accordion-inner">
                ...
                <div v-else-if="item.type === 'education'" class="documents-content">
                  <p>ИП Нафин Ильмир Фанилевич ведет образовательную деятельность на <br>
