...
const photos = ref<Photo[]>([
  {
    id: 1,
    filename: new URL('@/assets/reviews/review1.jpg', import.meta.url).href,
  },
  {
    id: 2,
    filename: new URL('@/assets/reviews/review2.jpg', import.meta.url).href,
  },
  {
    id: 3,
    filename: new URL('@/assets/reviews/review3.jpg', import.meta.url).href,
  },
  {
    id: 4,
    filename: new URL('@/assets/reviews/review4.jpg', import.meta.url).href,
  },
  {
    id: 5,
    filename: new URL('@/assets/reviews/review5.jpg', import.meta.url).href,
  },
  {
    id: 6,
    filename: new URL('@/assets/reviews/review6.jpg', import.meta.url).href,
  },
  {
    id: 7,
    filename: new URL('@/assets/reviews/review7.jpg', import.meta.url).href,
  },
  {
    id: 8,
    filename: new URL('@/assets/reviews/review8.jpg', import.meta.url).href,
  },
  {
    id: 9,
    filename: new URL('@/assets/reviews/review9.jpg', import.meta.url).href,
  }
])
